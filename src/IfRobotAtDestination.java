...
public class IfRobotAtDestination extends Node{
	 ...
	 */
	public IfRobotAtDestination(final Node robot, final Node child1, final Node child2) {
	 ...
	 * @param child2 The second conditionally evaluated child node.
	 */
	public IfRobotAtDestination(final TrainingAndTestSet trainingAndTestSet, final Node child1, final Node child2) {
		super(child1, child2);
	 ...
	 * is evaluated. An exception will be thrown if this argument is null.
	 */
	public IfRobotAtDestination(final TrainingAndTestSet trainingAndTestSet) {
	...
	public Void evaluate() {
		...
		this.robotsAndGraph = this.robotsAndGraphList.list[this.robotsAndGraphList.currExample];
		//System.out.println("IF ROBOT AT DESTINATION");
	...
	public String getIdentifier() {
		return "IF-ROBOT-AT-DESTINATION";
	}
