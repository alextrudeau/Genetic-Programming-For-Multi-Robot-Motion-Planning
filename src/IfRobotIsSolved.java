...
public class IfRobotIsSolved extends Node{
	 ...
	 */
	public IfRobotIsSolved(final Node robotsAndGraphList, final Node child1, final Node child2) {
	 ...
	 * @param child2 The second conditionally evaluated child node.
	 */
	public IfRobotIsSolved(final TrainingAndTestSet trainingAndTestSet, final Node child1, final Node child2) {
		super(child1, child2);
	 ...
	 * is evaluated. An exception will be thrown if this argument is null.
	 */
	public IfRobotIsSolved(final TrainingAndTestSet trainingAndTestSet) {
	...
	public Void evaluate() {
		...
		this.robotsAndGraph = this.robotsAndGraphList.list[this.robotsAndGraphList.currExample];
		//System.out.println("IF ROBOT IS SOLVED");
